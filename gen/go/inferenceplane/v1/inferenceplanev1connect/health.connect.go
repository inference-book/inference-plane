...
const (
	...
	HealthServiceName = "inferenceplane.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/inferenceplane.v1.HealthService/Check"
)
...
// NewHealthServiceClient constructs a client for the inferenceplane.v1.HealthService service. By
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_inferenceplane_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Check calls inferenceplane.v1.HealthService.Check.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/inferenceplane.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("inferenceplane.v1.HealthService.Check is not implemented"))
}
