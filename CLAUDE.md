...
| `iplane mock-engine` | (hidden, dev/CI) standalone OpenAI-compatible mock engine over the mock backend; pair with `--provider external` for a GPU-free multi-replica harness |
