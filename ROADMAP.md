...
| 3 | Telemetry seeding                        | active | Cp boots cloudflared quick tunnel (lab default) or accepts `--otel-endpoint <url>`; deploy passes `OTEL_EXPORTER_OTLP_ENDPOINT` to data plane container. |
