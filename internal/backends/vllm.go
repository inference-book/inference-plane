...
func NewVLLM(name, baseURL string) *VLLMBackend {
	// otelhttp.NewTransport wraps the default transport so outbound calls
	// to vLLM get an auto-generated span and the W3C Trace Context headers
	// are added. Combined with the inbound otelhttp.NewHandler (in
	// internal/server), this gives us end-to-end trace correlation across
